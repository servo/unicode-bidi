...
from bidiCharacterTestParser.py import parse_all_test_cases_from_BidiCharacterTest_txt
...
if __name__ == "__main__":
    ...
    # Sam put code here
    # parse all test cases from BidiCharacterTest.txt and place them in lib.rs after 'marker'
    # parse_all_test_cases_from_BidiCharacterTest_txt("//Test cases from BidiCharacterTest.txt go here\n")
